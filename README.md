...
<p align="justify">
    The location of the Nth digit of Pi is denoted by <i>P<sub>n</sub>(x<sub>n</sub>, y<sub>n</sub>)</i>, with position vector U+20D7. The location of the particle is denoted by <i>P(x, y)</i>.
</p>
<p align="center">
